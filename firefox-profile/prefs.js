...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1784956768);
user_pref("app.update.lastUpdateTime.background-update-timer", 1784956768);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1784956768);
user_pref("app.update.lastUpdateTime.glean-addons-daily", 1784956768);
user_pref("app.update.lastUpdateTime.region-update-timer", 1784956768);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1784956737);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1784956768);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1784956768);
user_pref("app.update.migrated.updateDir3.17E4801A417B7D6D", true);
user_pref("app.update.mode", 0);
user_pref("app.update.service.enabled", false);
user_pref("apz.content_response_timeout", 60000);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "custom");
user_pref("browser.contextual-services.contextId", "b0ec878e-2fb1-466b-aa99-19da0fd38eea");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1784956737);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{65c8c486-e2f6-4e36-910c-04290977143d}");
...
user_pref("browser.startup.lastColdStartupCheck", 1784956738);
...
user_pref("captchadetection.lastSubmission", 1784956);
user_pref("captivedetect.canonicalURL", "");
user_pref("datareporting.dau.cachedUsageProfileGroupID", "001a9b49-ce57-4f5b-a0af-8ae8b66e930f");
user_pref("datareporting.dau.cachedUsageProfileID", "e61c131e-99bd-421a-9bb6-9ec05ad88fbe");
...
user_pref("extensions.webextensions.uuids", "{\"data-leak-blocker@mozilla.com\":\"e818cea5-3399-4262-bd96-b84b326773f8\",\"formautofill@mozilla.org\":\"c67d4bb6-42f1-4c86-9719-0c7f4e0e9b8c\",\"ipp-activator@mozilla.com\":\"b5775e5f-5b95-4e65-a321-1ba809c832eb\",\"pictureinpicture@mozilla.org\":\"570ce6ff-9140-4a47-a40d-6ada74545e88\",\"addons-search-detection@mozilla.com\":\"5c087edd-0811-47a4-a1fa-51385d3d90de\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"newtab@mozilla.org\":\"c4ef7b03-3b0e-46a9-ad67-95924efe232c\",\"default-theme@mozilla.org\":\"ca8317cc-7eae-4760-ac00-34256e815d32\"}");
...
user_pref("nimbus.profileId", "1b53f6c7-284e-4ef4-9de2-37c2ae057df3");
...
user_pref("toolkit.profiles.storeID", "ca038155");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1784956735);
